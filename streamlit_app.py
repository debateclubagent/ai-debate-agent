...
def render_card(title, content_dict, bg_color="#f9f9f9"):
    card_html = f"""
    <div style="background-color: {bg_color}; border-radius: 12px; padding: 20px; margin-bottom: 20px; box-shadow: 0 4px 10px rgba(0,0,0,0.06); border: 1px solid #e0e0e0; height: 100%; font-size: 15px;">
...
def render_training_card(title, content_dict, bg_color="#f0f7ff"):
    card_html = f"""
    <div style="background-color: {bg_color}; border-radius: 12px; padding: 20px; margin-bottom: 20px; box-shadow: 0 4px 10px rgba(0,0,0,0.06); border: 1px solid #dce3f0; height: 100%; font-size: 15px;">
        <h3 style="margin-top: 0; margin-bottom: 12px;">{title}</h3>
